                ...
                <div className="max-w-[480px] p-5 md:p-10">
                    ...
                    <ul className="flex justify-center gap-2 sm:gap-5 mb-5">
                        <li>
                            ...
                            >
                                <svg className="w-5 h-5 sm:w-6 sm:h-6 shrink-0" viewBox="0 0 256 193" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                    <g>
                                        <path
                        ...
                        <li>
                            <button
                                ...
                                className="btn flex gap-1 sm:gap-2 text-black shadow-none bg-white-dark/30 dark:border-[#253b5c] dark:hover:bg-[#1b2e4b] dark:bg-transparent dark:text-white hover:bg-white"
                            >
                                <svg className="w-5 h-5 sm:w-6 sm:h-6 shrink-0" viewBox="0 0 256 250" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                    <g>
                                        <path
                        ...
                        <li>
                            <button
                                ...
                                className="btn flex gap-1 sm:gap-2 text-black shadow-none bg-white-dark/30 dark:border-[#253b5c] dark:hover:bg-[#1b2e4b] dark:bg-transparent dark:text-white hover:bg-white"
                            >
                                <svg className="w-5 h-5 sm:w-6 sm:h-6 shrink-0" viewBox="0 0 256 209" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                    <g>
                                        <path
